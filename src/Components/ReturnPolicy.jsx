...
const ReturnPolicy=()=> {
  ...
  <article className="max-w-4xl justify-center mx-auto bg-white shadow-lg rounded-2xl p-8 md:p-12 px-5">
    <header className="mb-8 mx-5">
    ...
    <section className="prose prose-md max-w-none mb-6 mx-5">
      <p>
        <strong>Owner Name:</strong> Dhiraj Jain
      </p>
      <p>
        <strong>Email ID:</strong>{" "}
        <a href="mailto:support@1XL.com" target="_blank" className="text-indigo-600 hover:underline">
          support@1XL.com
        </a>
      </p>
      <p>
      ...
      <p className="mt-4">
        ...
        >
          DrDhirajJain.com
        </a>, providing quality services and transparency is of utmost 
    ...
    <section className="mb-6 mx-5">
      ...
      <ul className="list-disc  text-justify space-y-2 text-gray-700">
        <li className="">
    ...
    {/* ---------------- Footer ---------------- */}
    <footer className="pt-6 mx-5 border-t border-gray-100 text-sm text-gray-600">
      <p>
