...
const ShippingPolicy = () => {
  return (
    <div className="max-w-5xl mx-auto px-16 py-12 text-gray-800 leading-relaxed shadow-2xl  my-12">
      ...
      <p className="mb-2">
        ...
        <a href="mailto:support@1XL.com" target="_blank"
      ...
      <p className="mb-3">
        This Shipping & Delivery Policy ("Policy") applies to all purchases made through <a
          href="https://DrDhirajJain.com"
          target="_blank"
          rel="noreferrer"
          className="text-blue-600 hover:underline"
      ...
      <p className="mb-3">
        Digital tickets with QR codes will be sent to the registered Email ID. The QR code
        is required for event entry. Users must ensure their Email ID is correct.
      </p>
      ...
      <p className="mb-6">
        ...
        resolved according to the terms and conditions of   <a
          href="https://DrDhirajJain.com"
          target="_blank"
          rel="noreferrer"
          className="text-blue-600 hover:underline"
